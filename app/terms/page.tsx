...
(the "Service"), operated by Treddit AI ("we", "us", or "our"), accessible at
...
<p>
We offer a 14-day refund policy on all paid subscriptions. If you are not satisfied
for any reason, you may request a full refund within 14 calendar days of your
payment. See our{' '}
<Link href="/refund" style={{ color: 'var(--blue)', textDecoration: 'none' }}>Refund Policy</Link>
{' '}for details.
</p>
</section>
...
use the Service ceases immediately. Sections 8, 10, 11, 12, and 15 survive termination.
</p>
</section>
