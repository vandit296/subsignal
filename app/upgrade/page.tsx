...
body: JSON.stringify({ plan: 'pro', ...(forceGlobal && { forceGlobal: true }) }),
});
...
<div style={{ fontSize: 12, color: 'rgba(255,255,255,0.28)', marginBottom: 40, letterSpacing: '-0.005em' }}>Cancel anytime</div>
